...
const Header = () => {
  return (
    <div className='w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4'>
      ...
      >
        <Image src={assets.profile_img} alt='' className='rounded-full w-32 mt-20 px-3'/>
     </motion.div>
     <motion.h3
     initial={{y: -20, opacity:0}}
     whileInView={{y: 0, opacity:1}}
     transition={{duration: 0.6, delay:0.3}} 
     className='flex items-end gap-2 text-xl md:text-2xl mb-3 font-Ovo'>Hi! I'm Nikita <Image src={assets.hand_icon} alt='' className='w-6'/></motion.h3>
     <motion.h1 
     ...
     I'm a passionate Full Stack Web Developer with expertise in building innovative web applications.
     </motion.p>
